        ...
        {!active ? (
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-lp-accent rounded-lg text-sm font-medium text-white disabled:opacity-70 hover:bg-lp-accent/80 transition-colors whitespace-nowrap"
            >
              ✨ Pulse
            </button>
          </div>
